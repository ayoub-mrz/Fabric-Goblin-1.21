...
public class FireDaveEntity extends HostileEntity implements GeoEntity {
...
//                .add(EntityAttributes.GENERIC_MAX_HEALTH, 25.0D)
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(2, new MeleeAttackGoal(this, 0.4D, true));
    ...
    private PlayState attackPredicate(AnimationState<FireDaveEntity> event) {
