...
public class RockProjectileModel extends EntityModel<RockProjectileEntity> {
    public static final EntityModelLayer ROCK = new EntityModelLayer(Identifier.of(GoblinMod.MOD_ID, "rock"), "main");
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData rock = modelPartData.addChild("rock", ModelPartBuilder.create().uv(0, 0).cuboid(-5.0F, -5.0F, -5.0F, 10.0F, 10.0F, 10.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 8.0F, 0.0F));
